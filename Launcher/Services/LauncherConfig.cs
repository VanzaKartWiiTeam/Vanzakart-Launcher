...
{
    public const string CurrentLauncherVersion = "1.4.0-rc.1";
    ...
    public const string NewsJsonUrl = "https://sitodaking.it:8443/Launcher/news.json";
    public const string DownloadPageUrl = "https://vwfc.sitodaking.it/";
    public const string MiiRenderingArchiveUrl = "https://web.archive.org/web/20180502054513id_/http://download-cdn.miitomo.com/native/20180125111639/android/v2/asset_model_character_mii_AFLResHigh_2_3_dat.zip";
    public const string DiscordAppId = "1475218891192926288";
    public const string ProductName = "VanzaKart Launcher";
    public const string LeaderboardApiUrl = "https://sitodaking.it:8443/api/vk_leaderboard.php";
    public const string LeaderboardDetailsApiUrl = "https://sitodaking.it:8443/api/leaderboard/";
    public const string RoomsApiUrl = "https://sitodaking.it:8443/api/vk_rooms.php";
