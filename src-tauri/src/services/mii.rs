...
fn view_of(block: &[u8]) -> AppResult<MiiView> {
    ...
    Ok(MiiView {
        ...
        name: crate::domain::wii_text::humanize(&parsed.name),
        creator_name: crate::domain::wii_text::humanize(&parsed.creator_name),
        ...
        avatar_initial: initial(&crate::domain::wii_text::humanize(&parsed.name)),
